...
import ButtonFactory from "./factories/NavBarButtonFactory.tsx";
...
const NavBar = () => {
    ...
    return (
        <div className="drawer z-50">
            <input id="my-drawer" type="checkbox" checked={Aberto} onChange={handleCheckboxChange}
                ...
                <nav className="navbar fixed top-0 bg-navbar lg:h-[77px] h-[40px] p-0 min-h-0">
                    <div className="navbar-start">
                        <div className="lg:ml-6 ml-2">
                            {isAuthenticated ? (
                                <p className="link hover:bg-navbar-hover rounded-full lg:p-3 p-1 lg:h-[65px] h-[33px]"
                    ...
                    <div className="bg-sidebar-bg shadow-xl rounded-lg">
                        <div className="bg-sidebar-title-bg rounded-t-lg">
                            <div className="flex flex-col justify-center items-center">
                                ...
                                <p className="mt-5 lg:text-2xl text-lg text-primary-text-detail">{user?.name != null ? user.username : "Unknown"}</p>
                        ...
                        <div className="flex flex-col justify-center items-center gap-y-2.5 p-2.5">
                            <ButtonFactory
                                ...
                                isDisabled={isDisabledSidebarButton("/")}
                                icon={<svg
                            ...
                            <ButtonFactory
                                ...
                                isDisabled={isDisabledSidebarButton("/dashboard")}
                                icon={<svg
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                                    className="lg:h-7 lg:w-7 h-5 w-5 mr-5 text-primary-text-detail"
                            ...
                            <ButtonFactory
                                ...
                                isActive={location.pathname === "/dashboard/championships"}
                                isDisabled={isDisabledSidebarButton("/dashboard/championships")}
                                icon={<svg
                            ...
                            <ButtonFactory
                                ...
                                isDisabled={isDisabledSidebarButton("/dashboard/trainers")}
                                icon={<svg
                                    viewBox="0 0 1024 1024"
                                    fill="currentColor"
                                    className="lg:h-7 lg:w-7 h-5 w-5 mr-5 text-primary-text-detail"
                            ...
                            <ButtonFactory
                                ...
                                isActive={location.pathname === "/dashboard/players"}
                                isDisabled={isDisabledSidebarButton("/dashboard/players")}
                                icon={<svg
                                    viewBox="0 0 448 512"
                                    fill="currentColor"
                                    className="lg:h-7 lg:w-7 h-5 w-5 mr-5 text-primary-text-detail"
                            ...
                            <ButtonFactory
                                ...
                                isDisabled={isDisabledSidebarButton("/dashboard/teams")}
                                icon={<svg
                                    viewBox="0 0 640 512"
                                    fill="currentColor"
                                    className="lg:h-7 lg:w-7 h-5 w-5 mr-5 text-primary-text-detail"
                            ...
                            <ButtonFactory
                                type="sidebar"
                                label="PARTIDAS"
                                onClick={() => handleSidebarButtonClick("/dashboard/matches")}
                                isActive={location.pathname === "/dashboard/matches"}
                                isDisabled={isDisabledSidebarButton("/dashboard/matches")}
                                icon={<svg
                                    data-name="Layer 1"
                                    viewBox="0 0 24 24"
                                    fill="currentColor"
                            ...
                            <div className="flex flex-row w-full gap-x-2.5">
                                <ButtonFactory
                                    ...
                                    isActive={false}
                                    isDisabled={false}
                                    icon={TailwindThemeAdapter.getTheme() == "dark" ? (
                                            <svg
