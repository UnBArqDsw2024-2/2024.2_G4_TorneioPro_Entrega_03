...
const ChampionshipFutureCard: React.FC<FutureCardProps> = ({
                                                               index,
                                                               closeDate,
                                                               championship,
                                                               sport,
    ...
    return (
        <li key={index}
            className="inline-block lg:py-5 py-4 lg:w-[20vw] w-[70vw] bg-slider-future rounded-[10px] lg:mr-3 mr-1.5 lg:px-6 px-4 snap-center">
            <div className="flex flex-col justify-center text-start">
                <p className="text-primary-text lg:text-xl text-base overflow-clip text-ellipsis lg:mb-1.5 mb-0.5">{championship}</p>
                <p className="text-formPlaceholderText lg:text-lg text-sm lg:mb-1.5 mb-0.5">Inscrições
                    até: {closeDateConverted}</p>
                <p className="text-formPlaceholderText lg:text-lg text-sm lg:mb-10 mb-6">{sport}</p>

                <div
                    className="flex flex-col justify-center text-end w-full bg-slider-occupation rounded px-3 lg:pb-3 pb-2 lg:pt-2 pt-1.5">
