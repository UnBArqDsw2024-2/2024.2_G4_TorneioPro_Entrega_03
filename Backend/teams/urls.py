...
urlpatterns = [
    ...
    path('delete/', views.TeamViewSet.as_view({'delete': 'delete_team'}), name='team-delete'),
    path('add-player/', views.TeamViewSet.as_view({'post': 'add_player'}), name='team-add-player'),
    path('remove-player/', views.TeamViewSet.as_view({'delete': 'remove_player'}), name='team-remove-player'),
]
