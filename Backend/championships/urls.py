...
urlpatterns = [
    ...
    path('get/', views.ChampionshipViewSet.as_view({'post': 'get'}), name='championship-get'),
    path('update/', views.ChampionshipViewSet.as_view({'post': 'update'}), name='championship-update'),
    path('delete/', views.ChampionshipViewSet.as_view({'post': 'destroy'}), name='championship-delete'),
    
    # Join request endpoints
    path('join/request/', views.ChampionshipViewSet.as_view({'post': 'join_request'}), name='championship-join-request'),
    path('join/approve/', views.ChampionshipViewSet.as_view({'post': 'approve_request'}), name='championship-approve-request'),
    path('join/reject/', views.ChampionshipViewSet.as_view({'post': 'reject_request'}), name='championship-reject-request'),
